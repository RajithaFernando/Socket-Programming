...
my_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)  # AddressFamily (IPV4) and TCP connections
...
def handle_request(client):
    while True:
        ...
        try:
            ...
            # response_data = f.read()
            # f.close()
            response_header = generate_headers(200, 'html') #ayin karanna
